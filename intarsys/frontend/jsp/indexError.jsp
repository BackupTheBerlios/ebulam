...
<BODY NOF="(MB=(DefaultMasterBorder, 140, 50, 250, 10), L=(indexLayout, 700, 600))" BGCOLOR="#FFFFFF" BACKGROUND="/IntarSys/frontend/assets/images/background.gif" TEXT="#000000" LINK="#0033CC" VLINK="#990099" ALINK="#FF0000" TOPMARGIN="0" LEFTMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0">
