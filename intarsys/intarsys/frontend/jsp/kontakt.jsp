...
<BODY NOF="(MB=(Inside1, 140, 50, 250, 10), L=(KontaktLayout, 700, 600))" BGCOLOR="#FFFFFF" BACKGROUND="../assets/images/background.gif" TEXT="#000000" LINK="#0033CC" VLINK="#990099" ALINK="#FF0000" TOPMARGIN="0" LEFTMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0">
...
<!-- Neunter Button "Abmelden" -->
            ...
            <TD>
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="689" NOF="LY">
                    ...
                    <TR VALIGN="TOP" ALIGN="LEFT">
                        <TD HEIGHT="56"></TD>
                        <TD WIDTH="580"><IMG ID="Banner1" HEIGHT="56" WIDTH="580" SRC="../assets/images/autogen/Kontakt_NBanner.gif" BORDER="0" ALT="Kontakt" NOF="B_H"/></TD>
                    </TR>
                </TABLE>
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="693" NOF="LY">
                    <TR VALIGN="TOP" ALIGN="LEFT">
                        <TD WIDTH="109" HEIGHT="85"><IMG SRC="../assets/images/autogen/clearpixel.gif" WIDTH="109" HEIGHT="1" BORDER="0"/></TD>
                        <TD WIDTH="584"><IMG SRC="../assets/images/autogen/clearpixel.gif" WIDTH="584" HEIGHT="1" BORDER="0"/></TD>
                    </TR>
                    <TR VALIGN="TOP" ALIGN="LEFT">
                        <TD></TD>
                        <TD WIDTH="584">
                            <P><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif"><B>Per Mail erreichen Sie uns am schnellsten:</B></FONT><B></B></P>
                            <P><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif"></FONT></P>
                            <P><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif"></FONT><A HREF="mailto:AndreasLutzi@Gmx.de"></A><A HREF="mailto:AndreasLutzi@Gmx.de"><FONT COLOR="#003366" SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Andreas Lutz</FONT></A></P>
                            <P><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif"></FONT></P>
                            <P><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif"></FONT><A HREF="mailto:StefanMax@Gmx.de"><FONT COLOR="#003366" SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Stefan Max</FONT></A></P>
                            <P><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif"></FONT></P>
                            <P><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif"></FONT><A HREF="mailto:johann.bergen@web.de"><FONT COLOR="#003366" SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Johann Bergen</FONT></A><A HREF="mailto:johann.bergen@web.de"></A></P>
                        </TD>
                    </TR>
                </TABLE>
                <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" NOF="LY">
                    <TR VALIGN="TOP" ALIGN="LEFT">
                        <TD WIDTH="150" HEIGHT="325"><IMG SRC="../assets/images/autogen/clearpixel.gif" WIDTH="150" HEIGHT="1" BORDER="0"/></TD>
                        <TD></TD>
                    </TR>
                    <TR VALIGN="TOP" ALIGN="LEFT">
                        <TD></TD>
                        <!--TD NOWRAP NOF="NB_PNHT">
                            <P><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">[</FONT><A HREF="../html/news.html"><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">News</FONT></A><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">][</FONT><A HREF="../html/produkte.html"><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Produkte</FONT></A><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">][</FONT><A HREF="../html/support.html"><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Support</FONT></A><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">][</FONT><A HREF="../html/newsletter.html"><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Newsletter</FONT></A><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">][</FONT><A HREF="../html/seminare.html"><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Seminare</FONT></A><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">][</FONT><A HREF="../html/kontakt.html"><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Kontakt</FONT></A><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">][</FONT><A HREF="../html/kundendaten.html"><FONT SIZE="-1" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">Kundendaten</FONT></A><FONT SIZE="-2" FACE="Verdana,Tahoma,Arial,Helvetica,sans-serif">]</FONT></P>
                        </TD-->
                    </TR>
                </TABLE>
            </TD>
